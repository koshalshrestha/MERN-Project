...
export const Detail = () => {
    ...
    return loading ? <Loading /> : <div className="col-12">
        <main className="row">
                ...
                <div className="row">
                        ...
                        <div className="col-12">
                            <div className="row">
                                {product.images?.map((image, i) => <div key={i} className="col-sm-2 col-3" onMouseEnter={() => setImgLarge(image)}>
                                    <div className="img-small border" style={{backgroundImage: `url('${imgUrl(image)}')`}} data-src="images/image-1.jpg"></div>
                                </div>)}                              
                    ...
                    <div className="col-lg-2 col-md-3 text-center">
                        <div className="col-12 sidebar h-100">
                            <div className="row">
                                {product.discountedPrice > 0 ? <><div className="col-12">
                                ...
                                </div></> : <span className="detail-price">
                                        Rs. {product.price}
                                    </span>}
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col">
                                            <ul className="rating-list mt-3">
                                                ...
                                                <li>
                                                    <div className="progress">
                                                        <div className="progress-bar bg-dark" role="progressbar" style={{width: '55%'}} aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">15%</div>
                                                    </div>
                                                    <div className="rating-progress-label">
            ...
            {similars.length > 0 && <ProductSection title='Similar Products' products={similars} /> }
